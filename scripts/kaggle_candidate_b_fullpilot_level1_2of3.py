# ============================================================
# CANDIDATE B FULL PILOT -- difficulty stratum 1 of 3, sub-split 2of3 of 3
...
# MATH-500 difficulty stratum (level 1, problems 2-3 of 6).
...
#
# problem_id is "d1_prob{pi}" with pi in [2,4) -- the SAME
# global numbering the undivided level-1 script would have used, so this
...
# ------------------------------------------------------------
DIFFICULTY_LEVEL = "1"    # MATH-500's own level field -- this stratum
...
for _local_pi, item in enumerate(problems):
    ...
    # undivided level-1 script (or the other 2 sub-notebooks of this same
