# ============================================================
# CANDIDATE B FULL PILOT -- difficulty stratum 1 of 3, sub-split 3of3 of 3
...
# MATH-500 difficulty stratum (level 1, problems 4-5 of 6).
...
#
# problem_id is "d1_prob{pi}" with pi in [4,6) -- the SAME
...
SUB_START = 4                    # this sub-notebook's problem slice within the stratum
SUB_END = 6                        # exclusive
...
# ------------------------------------------------------------
# DATA -- this stratum's problems 4-5 of 6 (MATH-500 level == DIFFICULTY_LEVEL)
# ------------------------------------------------------------
