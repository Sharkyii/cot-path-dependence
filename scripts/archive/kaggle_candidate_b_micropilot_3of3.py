# ============================================================
# CANDIDATE B MICRO-PILOT -- NOTEBOOK 3 of 3 (problems [6, 8) of 8)
#
# Run this in its OWN Kaggle session, in parallel with the other two
# notebooks (different browser tab / different account). Each notebook's
# problems, matching, and branching are fully independent -- no
# coordination needed. Results concatenate afterward: just pool all three
# notebooks' RECONSTRUCTION-style output / pair_results.json together for
# a combined Fisher's-method p-value across all ~20 branched pairs.
#
# problem_id values are GLOBAL (offset by PROBLEM_START), so they will
# NOT collide with the other two notebooks' output -- verified before
# splitting (see DESIGN_CANDIDATE_B.md).
# ============================================================
