# ============================================================
# CANDIDATE B MICRO-PILOT -- NOTEBOOK 2a (of the 2a/2b split of 2of3) (problems [3, 5) of 8)
#
# This is a further split of the original "notebook 2 of 3" (problems
# 3-5), which was taking too long as one piece. Run in its OWN Kaggle
# session, independent of notebooks 1of3 and 3of3 (already complete) and
# independent of the other 2x/2y half. No coordination needed -- same
# reasoning as the original 3-way split: problems, matching, and
# branching never cross problem boundaries.
#
# problem_id values are GLOBAL (offset by PROBLEM_START) -- verified
# disjoint from every other notebook's range, including the other half
# of this split.
# ============================================================
